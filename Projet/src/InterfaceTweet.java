...
public class InterfaceTweet extends Application {
    ...
    void construireScene(Stage primaryStage)
    {
        ...
        TableView<Tweet> table = construireTableView();
    ...
    private void createFormAddNew(Stage primaryStage,TableView<Tweet> table) {
    ...
    private TableView<Tweet> construireTableView() {
